...
export default function Tweet({
  ...
  forwardedTweet,
  'text' | 'id' | 'author' | 'media' | 'created_at' | 'public_metrics'
>) {
  ...
  return (
    <div className="tweet rounded-lg border border-gray-200 dark:border-gray-700 px-6 py-4 my-4 w-full bg-white dark:bg-gray-800">
